-- Standardize tenant bootstrap across all creation paths and
-- block self-service membership insertion outside admin/invite flows.

-- Backfill tenants created after the original bootstrap migrations but without a usable reopen password.

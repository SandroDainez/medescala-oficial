-- Enforce movement deletion with the same tenant-scoped password used to reopen schedules.
...
BEGIN
  ...
  IF NOT public.verify_schedule_reopen_password(_tenant_id, trim(COALESCE(_password, ''))) THEN

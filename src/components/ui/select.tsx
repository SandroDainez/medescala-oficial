...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ref={ref}
    className={cn(
      "relative mb-1 flex w-full cursor-default select-none items-center rounded-lg border border-border/60 px-3 py-2 pl-8 text-sm outline-none data-[disabled]:pointer-events-none data-[disabled]:opacity-50 data-[highlighted]:border-emerald-500/60 data-[highlighted]:bg-emerald-500/10 data-[state=checked]:border-emerald-500/60 data-[state=checked]:bg-emerald-500/10",
      className,
    )}
    {...props}
  >
